...
namespace SistemasAmigables\Providers {
use Illuminate\Support\ServiceProvider;
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        $this->app->bind('Illuminate\\Contracts\\Auth\\Registrar', 'SistemasAmigables\\Services\\Registrar');
    }
}
}
...
class BusServiceProvider extends ServiceProvider
{
    public function boot(Dispatcher $dispatcher)
    {
        $dispatcher->mapUsing(function ($command) {
            return Dispatcher::simpleMapping($command, 'SistemasAmigables\\Commands', 'SistemasAmigables\\Handlers\\Commands');
        });
    }
    public function register()
    {
...
class RouteServiceProvider extends ServiceProvider
{
    protected $namespace = 'SistemasAmigables\\Http\\Controllers';
    public function boot(Router $router)
    {
        parent::boot($router);
    }
